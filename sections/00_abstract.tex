...
($\omega_{n,\mathrm{rod}} = \SI{12.386}{\radian\per\second}$, $\zeta_\mathrm{rod} = 0.0984$)
...
ได้แก่ Overshoot ไม่เกิน 1\% (P5), Settling time ไม่เกิน 0.5~s (P6),
ความแม่นยำตำแหน่ง $\pm$[VAL\_ACCURACY]$\degree$ (A1),
ความซ้ำซากได้ $\pm$[VAL\_REPEAT]$\degree$ ใน 100 รอบ (A2)
และ Cycle time รวม [VAL\_CYCLE]~วินาที (P1)
...
including overshoot not exceeding 1\% (P5), settling time within 0.5~s (P6),
position accuracy of $\pm$[VAL\_ACCURACY]$\degree$ (A1),
repeatability of $\pm$[VAL\_REPEAT]$\degree$ over 100 cycles (A2),
and a total cycle time of [VAL\_CYCLE]~s for four workpieces (P1).
