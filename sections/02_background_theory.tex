...
และแสดงรายละเอียดไว้ใน\cref{subsec:pid_design} และ\cref{tab:pid_gains_hw}
...
\begin{itemize}
    \item \textbf{Cable Segregation:} สายไฟฟ้ากำลัง (Power Cables) และสายสัญญาณ (Signal Cables) จะต้องถูกแยกเดินในรางเก็บสาย (Wire Duct) ที่ต่างกัน โดยมีระยะห่างอย่างน้อย 50 มิลลิเมตร หากมีความจำเป็นต้องเดินสายพาดผ่านกัน จะต้องจัดวางให้ตัดกันแบบตั้งฉาก ($90^\circ$) เพื่อลดค่าความเหนี่ยวนำร่วม (Mutual Inductance) ให้เหลือน้อยที่สุด
...
ที่มีเฟสต่างกัน 90° ทำให้สามารถระบุทิศทางการหมุนได้
...
\begin{equation}
    \theta\;(\text{deg}) = \frac{N_{count}}{8192} \times 360°
